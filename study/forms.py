...
class ProfileForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['bio'].widget.attrs['placeholder'] = 'Please include a brief description of yourself! Feel free to list any specific courses/topics where you are looking for help or feel you could help others.'
